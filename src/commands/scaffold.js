...
export default async function scaffoldCommand(_args = [], deps = {}) {
  ...
  if (!(await pathExists(scaffoldPath))) {
    throw new Error(
      '.draftwise/scaffold.json not found. This file is generated by `draft init` in greenfield mode. If you ran init in agent mode, ask your coding agent to write scaffold.json from the conversation, or write it manually.',
    );
  }
